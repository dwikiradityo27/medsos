    ...
    <div class="container text-center">
        ...
        @foreach ($feeds as $feed)
            <div class="position-relative d-inline-block">
                ...
                <form action="{{ route('feeds.destroy',$feed->id) }}" method="POST" class="position-absolute" style="top: 10px; right: 10px;">
                    @csrf
                    @method('DELETE')
            ...
            <br>
        @endforeach
        <a class="btn btn-success" href="{{ route('feeds.create') }}">Add</a>
    </div>
